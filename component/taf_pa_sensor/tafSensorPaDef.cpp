...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_Init(int8_t& listSize)
{
...
taf_pa_sensor_SensorId PA_WEAK tafpa::sensor::taf_pa_sensor_GetSensorClient(const std::string& sensorName)
{
    PA_INFO("Using default PA for Sensor. Feature unsupported.");
    (void)sensorName;
    return 0;
...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_ReleaseSensorClient(taf_pa_sensor_SensorId sensorId)
{
    PA_INFO("Using default PA for Sensor. Feature unsupported.");
    (void)sensorId;
    return PA_NOT_IMPLEMENTED;
...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_Activate(
...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_SetEulerAngle(
    taf_pa_sensor_SensorId sensorId,
    double pitch,
    double roll,
    double yaw
...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_Deactivate(taf_pa_sensor_SensorId sensorId)
{
    PA_INFO("Using default PA for Sensor. Feature unsupported.");
    (void)sensorId;
    return PA_NOT_IMPLEMENTED;
...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_SelfTest(
    taf_pa_sensor_SensorId sensorId,
...
pa_result_t PA_WEAK tafpa::sensor::taf_pa_sensor_RegisterListener(
    taf_pa_sensor_SensorId sensorId,
